    ...
    render() {
        return (<>
            <nav className="navbar navbar-white bg-white fixed-top py-4">
               <a href="/" className="text-decoration-none"><h1 className="text-primary">Clicky Frenzy</h1></a>
                {this.state.status}
            ...
            <div className="jumbotron bg-primary jumbotron-fluid mt-5">
                <div className="container">
                    <h1 className="display-1 text-white text-center"><strong>Clicky Frenzy</strong></h1>
                    <h3 className="text-center text-white">Click on an image to earn points, but don't click on any more than once!</h3>
                </div>
            </div>
            <div className={`container bg-dark pt-3 mb-3 ${this.state.animation}`}>
                <div className="row">
                    {this.state.images.map(image => <div className="col-2 offset-md-1" >
                        <CardBody image={image} handleClick={this.handleClick} />
                    </div>)}
                </div>
            </div>
        </>
